...
<div class="container">
    ...
    <div class="mb-3 d-flex gap-2">
        <a href="{{ url('/visitas/attendcent') }}" class="btn btn-success">Ver Presentes</a>
        <a href="{{ url('/visitas/absents') }}" class="btn btn-danger">Ver Ausentes</a>
        <a href="{{ route('visits.index') }}" class="btn btn-secondary">Ver Todas</a>
    </div>
            ...
            @foreach ($visits as $visit)
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        ...
                        <!-- Removido o botão de "Marcar Saída" -->
                        @if ($visit->exit)
                            <button class="btn btn-sm btn-secondary" disabled>Visitou</button>
                        @endif
                    </td>
                </tr>
            @endforeach
